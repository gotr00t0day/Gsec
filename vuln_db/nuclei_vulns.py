...
def nuclei_ultimate_scan(domain: str) -> str:
    ...
    sub_output.subpro_scan(f"nuclei -u {domain} -tags cve -severity medium,critical,high -silent")
    ...
    sub_output.subpro_scan(f"nuclei -u {domain} -t vulnerabilities/ -severity medium,critical,high -silent")
    ...
    sub_output.subpro_scan(f"nuclei -u {domain} -t misconfiguration/ -severity medium,critical,high -silent")
